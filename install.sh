...
echo ""
wget -q ${url}/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear

yellow "Add Domain for ssh/vmess/vless/trojan dll"
yellow "Jika tidak mempunyai domain Hubungi FREE TUNNELING PROJECT"
echo "-------------------------------------"
...
clear
wget ${url}/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
wget ${url}/websocket/nontls.sh && chmod +x nontls.sh && ./nontls.sh
clear
...
sleep 2
wget ${url}/update/update.sh && chmod +x update.sh && ./update.sh
clear
ln -fs /usr/share/zoneinfo/Asia/Jakarta /etc/localtime
clear
cat> /root/.profile << END
